...
CREATE TABLE IF NOT EXISTS pa_events (
    ...
    base1_runner_id TEXT REFERENCES players(player_id),
    base2_runner_id TEXT REFERENCES players(player_id),
    base3_runner_id TEXT REFERENCES players(player_id),
    base1_runner_name TEXT,
    base2_runner_name TEXT,
    base3_runner_name TEXT,
    home_score INTEGER,
    away_score INTEGER,
    home_hits INTEGER,
    away_hits INTEGER,
